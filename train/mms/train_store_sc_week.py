...
class Trainer(TrainerBase):
    ...
    def get_source_data(self):
        if self.args.training_type == 'online':
            ...
            if self.args.training_model == 'allocate':
                sql = READ_SQL['MMS']['STORE_SC_WEEK']['ALLOCATE']
            elif self.args.training_model == 'transform':
                sql = READ_SQL['MMS']['STORE_SC_WEEK']['TRANSFORM']
            else:
            ...
            for col in DTYPE_PARAMS['MMS']['STORE_SC_WEEK']:
                df_source_data[col] = df_source_data[col].astype(DTYPE_PARAMS['MMS']['STORE_SC_WEEK'][col])
            ...
            df_source_data = pd.read_csv(
                ...
                dtype=DTYPE_PARAMS['MMS']['STORE_SC_WEEK'],
                low_memory=False
            )
    ...
    def feature_engineering(self):
        ...
        # 数据范围压缩
        self.__df_useful_data['sales_qty'] = self.__df_useful_data['sales_qty'].clip(lower=0, upper=40)
    ...
    def preprocessing(self):
        ...
        df_data.set_index(['store_code', 'sub_cate'], inplace=True)
    ...
    def test_model(self):
        ...
        # 训练
        bst = lgb.train(
            params=REG_PARAMS['MMS']['STORE_SC_WEEK']['LGB'],
            train_set=dtrain,
    ...
    def save_model(self):
        if self.model is None:
            ...
            model_file_name = 'model_{}_{}_{}_store_sc_week.txt'.format(
