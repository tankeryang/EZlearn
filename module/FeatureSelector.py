...
class FeatureSelector():
    ...
    def __init__(self, data, labels=None):
        ...
        if labels is None:
            logging.warning('No labels provided. Feature importance based methods are not available.')
    ...
    def identify_zero_importance(
        ...
        if early_stopping and eval_metric is None:
            raise ValueError(
                """eval metric must be provided with early stopping. Examples include "auc" for classification or "l2" for regression."""
            )
